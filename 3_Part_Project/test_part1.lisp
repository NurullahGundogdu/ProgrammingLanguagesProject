...
(defun list-leveller (l)
  (cond ((null l) nil)		;;nil is returned if the list is empty
        ((atom (car l)) (cons (car l) (list-leveller  (cdr l))))   ;;ATOM function returns true if the argument is not a cons cell, otherwise it returns false.
        (t (append (list-leveller  (car l)) (list-leveller  (cdr l))));;adds the non-parenthesis of the list
   )
) 
